...
# This row contains the mass values for each planet
planet_masses = planets.loc['Mass (10**24kg)'] 
# This line retrieves the index of the planet_masses series, which contains the names of the planets
planet_names = planet_masses.index 

# plot the graph
plt.figure(figsize=(10, 6))
# planet_names provides the labels for the x-axis ; planet_masses provides heights of the bars
